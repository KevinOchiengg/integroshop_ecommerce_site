...
const data = {
  users: [
    {
      name: 'Ko-technologiz',
      email: 'kotechnologiz@gmail.com',
      password: bcrypt.hashSync('kotechnologiz', 8),
      isAdmin: true,
      isSeller: true,
      seller: {
        name: 'Nike',
